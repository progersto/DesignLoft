...
//    private var listProducts = mutableListOf<ProductItem>()
    ...
    private fun initProductList(): ArrayList<ProductItem> {
        ...
        listCategory.add(ProductItem(null, "Стул", "http://www.vashdom.ru/files/articles/6000/6014/2.jpg", 200, false, 5))
        listCategory.add(ProductItem(null, "Стул1", "http://rusmebelshop.ru/img/image/divan.jpg", 2030, false, 5))
        listCategory.add(ProductItem(null, "Диван", "http://rusmebelshop.ru/img/image/kreslo1.jpg", 2020, false, 4))
        listCategory.add(ProductItem(null, "Диван1", "http://rusmebelshop.ru/img/image/kreslo3.jpg", 2010, false, 4))
        listCategory.add(ProductItem(null, "Стол", "https://images.clipartlogo.com/files/istock/previews/1048/104875165-wooden-chairs-on-a-white-background-wooden-furniture.jpg", 200, false, 1))
        listCategory.add(ProductItem(null, "Стол1", "http://v.albinos.com.ua/p/dzhenifer-stul-1141-product-375-242.jpeg", 2010, false, 1))
        listCategory.add(ProductItem(null, "Гардероб", "http://v.albinos.com.ua/p/a-042-krokus-barniy-stul-6983-product-375-242.jpeg", 200, false, 2))
        listCategory.add(ProductItem(null, "Декор", "http://v.albinos.com.ua/p/krokus-c105-stul-4778-product-375-242.jpeg", 2020, false, 3))
        listCategory.add(ProductItem(null, "Лампа", "http://v.albinos.com.ua/p/krokus-c105-stul-4778-product-375-242.jpeg", 2001, false, 6))
        listCategory.add(ProductItem(null, "Лампа1", "http://v.albinos.com.ua/p/krokus-c105-stul-4778-product-375-242.jpeg", 2010, false, 6))
        listCategory.add(ProductItem(null, "Кровать", "http://v.albinos.com.ua/p/krokus-c105-stul-4778-product-375-242.jpeg", 2002, false, 7))
        listCategory.add(ProductItem(null, "Люстра", "http://v.albinos.com.ua/p/krokus-c105-stul-4778-product-375-242.jpeg", 2030, false, 8))
        listCategory.add(ProductItem(null, "Люстра1", "http://v.albinos.com.ua/p/krokus-c105-stul-4778-product-375-242.jpeg", 2004, false, 8))
